...
const Settings = () => {
  ...
  const handleSave = async () => {
    if (!validateApiKey(openaiKey)) {
      setSaveMessage(
        "Invalid API key format. OpenAI keys start with 'sk-' and are longer."
      );
    ...
    <div className="flex flex-col items-center p-8 max-w-2xl">
        ...
        <h2 className="text-xl font-semibold text-white mb-4 flex items-center">
          ...
          >
            <path
              ...
              strokeWidth={2}
              d="M15 7a2 2 0 012 2m0 0a2 2 0 012 2m-2-2a2 2 0 00-2 2m2-2V5a2 2 0 00-2-2H9a2 2 0 00-2 2v2m6 0V9a2 2 0 00-2 2m0 0a2 2 0 002 2h4a2 2 0 002-2V9a2 2 0 00-2-2h-4z"
            />
          </svg>
          OpenAI API Key
        </h2>
      ...
      <div className="mt-8 bg-blue-900/20 border border-blue-700 rounded-2xl p-6">
        ...
        <div className="text-blue-200 text-sm space-y-2">
          <p>
            This app uses OpenAI's GPT-4 to analyze video transcripts and
            identify the most engaging clips for short-form content.
          </p>
          <p>
            <strong>What it does:</strong> Analyzes your video transcript to
            find moments with high engagement potential, complete thoughts, and
            natural clip boundaries.
          </p>
          <p>
            <strong>Privacy:</strong> Only the transcript text (not the video)
            is sent to OpenAI for analysis.
          </p>
        </div>
      </div>
    </div>
